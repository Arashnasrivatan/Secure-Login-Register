...
// SMS SEND CODE HERE
// ---------------------
$_SESSION['success'] = "Password change link has been successfully sent to you";
        ...
        <div class="flex min-h-screen items-center justify-center bg-background">
            <div class="container">
                <div class="mx-auto max-w-[450px] rounded-xl bg-muted p-5 shadow-base md:p-10">
                    ...
                    <h1 class="mb-5 text-center text-lg">Forgot password</h1>
 ...
 ?>
                    ...
                    <div class="mb-4 space-y-4">
                        <label for="mobile" class="relative block rounded-lg border shadow-base">
                            <input type="text" id="mobile" dir="auto" name="mobile" required minlength="11"
                                maxlength="11" value="<?php if(isset($_POST['mobile'])) echo $_POST['mobile']; ?>"
