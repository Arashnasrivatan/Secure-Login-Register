...
$buttontext = 'Send Verification code'; // "Send Verification Code"
...
if (isset($_POST['submitbtn']) && !isset($_POST['code'])) {
 ...
 // Insert the mobile number and verification code into the SMS code table
...
if (isset($_POST['mobile']) && isset($_POST['code']) && strlen($_POST['code']) == 4) {
 ...
 $_SESSION['success'] = 'You have successfully registered'; // "Registration successful"
 } else {
 // Store error message in the session if the codes do not match
 $_SESSION['error'] = 'The entered code is wrong'; // "The entered code is incorrect"
 }
}
?>
<!DOCTYPE html>
...
<body>
        ...
        <div class="flex min-h-screen items-center justify-center bg-background">
            <div class="container">
                <div class="mx-auto max-w-[450px] rounded-xl bg-muted p-5 shadow-base md:p-10">
                    <!-- Logo -->
                    <a href="./index.php">
                        <img src="./assets/images/logo.png" class="mx-auto mb-8 w-40" alt="" />
                    </a>
                    <h1 class="mb-5 text-center text-lg">Register</h1>
                    <p class="h-4 text-sm text-red-600 dark:text-red-400 text-center mb-2">
                        <?php if(isset($_SESSION['error'])){ echo $_SESSION['error']; unset($_SESSION['error']); } ?>
                    </p>
                    <p class="h-4 text-sm text-green-600 dark:text-green-400 text-center mb-2">
 ...
 echo'<meta http-equiv="refresh" content="2; url=login.php">';
                    ...
                    <div class="mb-4 space-y-4">
                        ...
                        <label for="namefull" class="relative block rounded-lg border shadow-base">
                            <input required type="text" id="namefull" name="namefull" dir="auto"
                                value="<?php if(isset($_POST['namefull'])) { echo $_POST['namefull']; } ?>"
                        ...
                        <label for="mobile" class="relative block rounded-lg border shadow-base">
                            <input required type="text" id="phonenumber" dir="auto" name="mobile"
                        ...
                        <label for="password" class="relative block rounded-lg border shadow-base">
                            <input required type="password" id="password" name="password" dir="auto"
                        ...
                        <?php
            if($val->isSuccess() && isset($_POST['submitbtn'])){
              echo '
              <label
              for="code"
             ...
             required
              ...
              ';
              if(isset($_POST['code']) && isset($_POST['submitbtn'])){
              $code=htmlspecialchars($_POST['code']);
              $val->name('code')
              ->value($code)
              ->min(4)
              ...
              ?>
                    ...
                    <div class="mb-5">
                        <button name="submitbtn" type="submit" class="btn-primary w-full py-3">Send confirmation
                            code</button>
                    </div>
