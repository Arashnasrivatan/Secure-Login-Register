...
<html dir="rtl" lang="fa">
  ...
  <body>
    ...
    <div class="flex min-h-screen items-center justify-center bg-background">
      <div class="container">
        <div
          class="mx-auto max-w-[450px] rounded-xl bg-muted p-5 shadow-base md:p-10"
        >
          <!-- Logo -->
          <a href="./index.php">
            <img
          ...
          <h1 class="mb-5 text-center text-lg">ثبت نام</h1>
...
required
        ...
        ->required();
          ...
          <div class="mb-5">
            <button name="submitbtn" type="submit" class="btn-primary w-full py-3">ارسال کد تایید</button>
          </div>
